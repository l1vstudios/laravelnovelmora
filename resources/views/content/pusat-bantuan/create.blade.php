...
@section('title', 'Tambah Pusat Bantuan')
    ...
    <div class="col-md-8">
        <div class="card">
            <div class="card-header d-flex align-items-center justify-content-between">
                <h5 class="mb-0">Tambah Pusat Bantuan</h5>
            ...
            <div class="card-body">
                ...
                <form action="{{ route('pusat-bantuan.store') }}" method="POST">
                    ...
                    <div class="mb-5">
                        ...
                        <input type="text" name="nama_layanan" class="form-control @error('nama_layanan') is-invalid @enderror" value="{{ old('nama_layanan') }}" autofocus>
                    ...
                    <div class="mb-5">
                        ...
                        <textarea name="isi_layanan" rows="8" class="form-control @error('isi_layanan') is-invalid @enderror">{{ old('isi_layanan') }}</textarea>
