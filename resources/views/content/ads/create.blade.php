                ...
                <form action="{{ route('ads.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row g-5">
                        <div class="col-md-8">
                            ...
                            <input type="text" name="title" class="form-control @error('title') is-invalid @enderror" value="{{ old('title') }}" placeholder="Contoh: Promo Paket Premium" autofocus>
                        ...
                        <div class="col-md-4">
                            ...
                            <select name="media_type" id="media_type" class="form-select @error('media_type') is-invalid @enderror">
                                <option value="image" {{ old('media_type', 'image') === 'image' ? 'selected' : '' }}>Gambar</option>
                        ...
                        <div class="col-12">
                            ...
                            <small class="text-muted">Gambar maks 5MB, video maks 20MB.</small>
                        </div>
                        <div class="col-12">
                            <label class="form-label">URL Media</label>
                            <input type="url" name="media_url" id="media_url" class="form-control @error('media_url') is-invalid @enderror" value="{{ old('media_url') }}" placeholder="https://...">
                            @error('media_url')<div class="invalid-feedback">{{ $message }}</div>@enderror
                            <small class="text-muted">Kosongkan jika memakai upload file.</small>
                        </div>
                        <div class="col-12">
                            <label class="form-label">URL Direct Link</label>
                            <input type="url" name="target_url" class="form-control @error('target_url') is-invalid @enderror" value="{{ old('target_url') }}" placeholder="https://...">
...
function updateAdsPreview() {
    ...
    const url = file ? URL.createObjectURL(file) : urlInput.value;
