            ...
            <div class="card-body">
                ...
                <form action="{{ route('faqs.store') }}" method="POST">
                    ...
                    <div class="mb-5">
                        ...
                        <input type="text" name="question" class="form-control @error('question') is-invalid @enderror" value="{{ old('question') }}" autofocus>
                        @error('question')<div class="invalid-feedback">{{ $message }}</div>@enderror
                    </div>
                    <div class="mb-5">
                        <label class="form-label">Jawaban <span class="text-danger">*</span></label>
                        <textarea name="answer" rows="5" maxlength="255" class="form-control @error('answer') is-invalid @enderror">{{ old('answer') }}</textarea>
                    ...
                    <div class="d-flex gap-3">
                        ...
                        <a href="{{ route('faqs.index') }}" class="btn btn-outline-secondary">Batal</a>
                    </div>
                </form>
            </div>
        </div>
