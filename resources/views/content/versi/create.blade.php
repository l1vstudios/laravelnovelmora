                ...
                <form action="{{ route('versi.store') }}" method="POST">
                    ...
                    <div class="row g-5">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="version_name" class="form-control @error('version_name') is-invalid @enderror" value="{{ old('version_name') }}" placeholder="contoh: 1.0.0" autofocus>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" name="version_code" class="form-control @error('version_code') is-invalid @enderror" value="{{ old('version_code') }}" placeholder="contoh: 1" min="1" max="2147483647">
