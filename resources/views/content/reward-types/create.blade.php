    ...
    <div class="col-md-7">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('reward-types.store') }}" method="POST">
                    @csrf
                    <div class="mb-5">
                        <label class="form-label">Kode Type <span class="text-danger">*</span></label>
                        <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" value="{{ old('name') }}" placeholder="nonton_iklan" autofocus>
                        @error('name')<div class="invalid-feedback">{{ $message }}</div>@enderror
                    </div>
                    <div class="mb-5">
                        <label class="form-label">Label <span class="text-danger">*</span></label>
                        <input type="text" name="label" class="form-control @error('label') is-invalid @enderror" value="{{ old('label') }}" placeholder="Nonton Iklan">
