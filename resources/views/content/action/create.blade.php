            ...
            <div class="card-body">
                ...
                <form action="{{ route('action.store') }}" method="POST">
                    ...
                    <div class="mb-5">
                        ...
                        <input type="text" name="action_name" class="form-control @error('action_name') is-invalid @enderror" value="{{ old('action_name') }}" placeholder="contoh: create_story, delete_user..." autofocus>
