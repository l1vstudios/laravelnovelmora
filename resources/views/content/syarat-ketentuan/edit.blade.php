            ...
            <div class="card-body">
                ...
                <form action="{{ route('syarat-ketentuan.update', $syaratKetentuan) }}" method="POST">
                    ...
                    <div class="mb-5">
                        ...
                        <input type="text" name="nama" class="form-control @error('nama') is-invalid @enderror" value="{{ old('nama', $syaratKetentuan->nama) }}">
                        @error('nama')<div class="invalid-feedback">{{ $message }}</div>@enderror
                    </div>
                    <div class="mb-5">
                        <label class="form-label">Isi Konten <span class="text-danger">*</span></label>
                        <textarea name="isi_konten" rows="10" class="form-control @error('isi_konten') is-invalid @enderror">{{ old('isi_konten', $syaratKetentuan->isi_konten) }}</textarea>
