...
@section('title', 'Edit Reward Harian')
    ...
    <div class="col-md-10">
        <div class="card">
            <div class="card-header d-flex align-items-center justify-content-between">
                <h5 class="mb-0">Edit Reward Harian</h5>
            ...
            <div class="card-body">
                ...
                <form action="{{ route('daily-rewards.update', $dailyReward) }}" method="POST">
                    @csrf @method('PUT')
                    @include('content.daily-rewards._form')
